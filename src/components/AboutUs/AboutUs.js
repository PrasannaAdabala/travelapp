      ...
      <Container>
        ...
        <Row className="hero-section text-center">
          <Col>
            ...
            <p className="lead">
              Welcome to <strong>Travel App</strong>! 🌍✈️
            </p>
            <p>
        ...
        <Row className="mt-5 story-section">
          <Col>
            ...
            <p className="text-center story-text">
              Founded in 2024, Travel app was born out of a passion for travel and adventure. Our mission is to make the world more accessible, allowing you to explore new places with ease and confidence. Whether it's a family vacation, solo adventure, or business trip, we're here to help you create unforgettable experiences.
            </p>
          </Col>
        </Row>
        ...
        <Row className="mt-5 text-center founder-section">
          <Col>
            ...
            />
            <h5 className="founder-name">Prasanna</h5>
            <p className="founder-title">Founder</p>
            <p className="founder-text">
              Prasanna started Travel app with a simple belief: travel should be seamless and enriching. His dedication to innovation and customer service has shaped the way we approach travel, making travel app a trusted name in the industry.
            </p>
          </Col>
        </Row>
      </Container>
